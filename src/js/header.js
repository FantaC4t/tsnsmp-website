    ...
    header.innerHTML = `
        <nav class="navbar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="https://discord.gg/5MhJyzMAk5" target="_blank" rel="noopener" class="nav-icon" aria-label="Join TSNSMP on Discord" title="Join TSNSMP on Discord"><img src="${assetsPath}icons/discord.svg" alt="Discord" class="nav-icon-img"></a></li>
